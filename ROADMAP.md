...
| HARDEN-01 | CLI-level exit-3 regression test | proposed | P1 | harness | `intents/harden-cli-exit3.md` | `main(["tdd", ...])` against a green suite exits 3 with the RED banner (covers the ex-NameError handler; import fix alone is unproven) | — |
