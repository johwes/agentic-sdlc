...
- gh-aw — [`steer:` run-scoped steering issues](https://github.github.com/gh-aw/reference/safe-outputs/) (keyword comments read mid-run — the closest shipped handoff protocol)
