...
- [ ] Bootstrap standalone demo repo `johwes/tic-tac-toe` (tic-tac-toe + planted bug + zero-dep node tests) + `tasks/inbox/TASK-403.json` frame with `repo_url` (see `specs/07-contracts.md`)
